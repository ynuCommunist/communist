...
public interface FindRepository extends JpaRepository<PersonData,String> {

    /*通过id查询*/
    Optional<PersonData> findById(String id);
    ...
    /*通过当前所在城市精确查询返回分组信息*/
    Page<PersonData> queryByLocationCountry(String name, Pageable pageable);

    /*通过当前所在城市模糊查询返回分组信息*/
    Page<PersonData> queryByLocationCountryLike(String name, Pageable pageable);

    Page<PersonData> findDistinctByNameLikeOrCityLikeOrLocationCountryLike(String finding1,String finding2,String finding3,Pageable pageable);
    ...
    /*通过国籍精确查询*/
    Page<PersonData> findByNationality (String nation, Pageable pageable);

    /*通过国籍模糊查询*/
    Page<PersonData> findByNationalityLike (String nation, Pageable pageable);

    /*通过民族精确查询*/
    Page<PersonData> findByNation (String nation, Pageable pageable);

    /*通过民族模糊查询*/
    Page<PersonData> findByNationLike (String nation, Pageable pageable);
    ...
    PersonData findFirstByCity(String city);

    PersonData findFirstByLocationCountry(String locationCountry);
}
